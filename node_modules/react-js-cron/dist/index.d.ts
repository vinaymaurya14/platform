...
declare function parseCronString(str: string): number[][];
...
declare const converter_d_parseCronString: typeof parseCronString;
declare namespace converter_d {
  export {
    ...
    converter_d_parseCronString as parseCronString,
  };
}
